...
impl TwixBackend {
    ...
    where
        ...
        T::Codec: Send + Sync,
    {
        self.subscribe_buffered_value(selector, Duration::ZERO)
    }
    ...
    where
        ...
        T::Codec: Send + Sync,
    {
        self.subscribe_value_with_qos(selector, transient_local_qos())
    }

    pub fn subscribe_value_with_qos<T>(
        &self,
        selector: impl Into<String>,
        qos: QosProfile,
    ) -> BufferHandle<T>
    ...
    pub fn subscribe_buffered_value_with_qos<T>(
        &self,
        selector: impl Into<String>,
        history: Duration,
        qos: QosProfile,
